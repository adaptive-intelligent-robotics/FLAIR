...
public:
  ...
  {
    // Parameters
    declare_parameter<std::vector<double>>("vectornav_init_transform", vector_nav_transform_);
    ...
    // We will use the SensorData QOS
    ...
    pub_time_startup_ =
      this->create_publisher<sensor_msgs::msg::TimeReference>("vectornav/time_startup", sensor_qos);
    pub_time_gps_ =
      this->create_publisher<sensor_msgs::msg::TimeReference>("vectornav/time_gps", sensor_qos);
    pub_time_syncin_ =
      this->create_publisher<sensor_msgs::msg::TimeReference>("vectornav/time_syncin", sensor_qos);
    pub_time_pps_ =
      this->create_publisher<sensor_msgs::msg::TimeReference>("vectornav/time_pps", sensor_qos);
    pub_imu_ = this->create_publisher<sensor_msgs::msg::Imu>("vectornav/imu", sensor_qos);
    pub_gnss_ = this->create_publisher<sensor_msgs::msg::NavSatFix>("vectornav/gnss", sensor_qos);
    pub_imu_uncompensated_ =
      this->create_publisher<sensor_msgs::msg::Imu>("vectornav/imu_uncompensated", sensor_qos);
    pub_magnetic_ =
      this->create_publisher<sensor_msgs::msg::MagneticField>("vectornav/magnetic", sensor_qos);
    pub_temperature_ =
      this->create_publisher<sensor_msgs::msg::Temperature>("vectornav/temperature", sensor_qos);
    pub_pressure_ =
      this->create_publisher<sensor_msgs::msg::FluidPressure>("vectornav/pressure", sensor_qos);
    pub_velocity_ = this->create_publisher<geometry_msgs::msg::TwistWithCovarianceStamped>(
      "vectornav/velocity_body", sensor_qos);
    pub_pose_ =
      this->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("vectornav/pose", sensor_qos);
    ...
    sub_vn_common_ = this->create_subscription<vectornav_msgs::msg::CommonGroup>(
      "vectornav/raw/common", sensor_qos, sub_vn_common_cb);
    ...
    sub_vn_time_ = this->create_subscription<vectornav_msgs::msg::TimeGroup>(
      "vectornav/raw/time", sensor_qos, sub_vn_time_cb);
    ...
    sub_vn_imu_ = this->create_subscription<vectornav_msgs::msg::ImuGroup>(
      "vectornav/raw/imu", sensor_qos, sub_vn_imu_cb);
    ...
    sub_vn_gps_ = this->create_subscription<vectornav_msgs::msg::GpsGroup>(
      "vectornav/raw/gps", sensor_qos, sub_vn_gps_cb);
    ...
    sub_vn_attitude_ = this->create_subscription<vectornav_msgs::msg::AttitudeGroup>(
      "vectornav/raw/attitude", sensor_qos, sub_vn_attitude_cb);
    ...
    sub_vn_ins_ = this->create_subscription<vectornav_msgs::msg::InsGroup>(
      "vectornav/raw/ins", sensor_qos, sub_vn_ins_cb);
    ...
    sub_vn_gps2_ = this->create_subscription<vectornav_msgs::msg::GpsGroup>(
      "vectornav/raw/gps2", sensor_qos, sub_vn_gps2_cb);
  }
...
private:
  ...
  void sub_vn_common(const vectornav_msgs::msg::CommonGroup::SharedPtr msg_in) const
  {
     ...
     // IMU
    {
      ...
      // Quaternion NED -> ENU
      tf2::Quaternion q, q_init_transform, q_init_inverse;
      fromMsg(msg_in->quaternion, q);
      // q_ned2enu.setRPY(M_PI, 0.0, M_PI / 2);
      auto transform = get_parameter("vectornav_init_transform").as_double_array();
      q_init_transform.setRPY(transform[0], transform[1], transform[2]);
      q_init_inverse = q_init_transform.inverse();
      msg.orientation = toMsg(q_init_transform * q * q_init_inverse);
      // msg.angular_velocity = msg_in->angularrate;
      // msg.linear_acceleration = msg_in->accel;
      msg.angular_velocity.x = msg_in->imu_rate.x;
      msg.angular_velocity.y = -1 * msg_in->imu_rate.y;
      msg.angular_velocity.z = -1 * msg_in->imu_rate.z;

      msg.linear_acceleration.x = msg_in->imu_accel.x;
      msg.linear_acceleration.y = -1 * msg_in->imu_accel.y;
      msg.linear_acceleration.z = -1 * msg_in->imu_accel.z;
  ...
  const std::vector<double> vector_nav_transform_ = {0.0000, 0.0000, 0.0000};
