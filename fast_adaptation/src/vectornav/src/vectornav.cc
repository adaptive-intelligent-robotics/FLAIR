...
public:
  Vectornav() : Node("vectornav")
  {
    ...
    pub_common_ = this->create_publisher<vectornav_msgs::msg::CommonGroup>("vectornav/raw/common", sensor_qos);
    pub_time_ = this->create_publisher<vectornav_msgs::msg::TimeGroup>("vectornav/raw/time", sensor_qos);
    pub_imu_ = this->create_publisher<vectornav_msgs::msg::ImuGroup>("vectornav/raw/imu", sensor_qos);
    pub_gps_ = this->create_publisher<vectornav_msgs::msg::GpsGroup>("vectornav/raw/gps", sensor_qos);
    pub_attitude_ = this->create_publisher<vectornav_msgs::msg::AttitudeGroup>("vectornav/raw/attitude", sensor_qos);
    pub_ins_ = this->create_publisher<vectornav_msgs::msg::InsGroup>("vectornav/raw/ins", sensor_qos);
    pub_gps2_ = this->create_publisher<vectornav_msgs::msg::GpsGroup>("vectornav/raw/gps2", sensor_qos);
...
private:
  ...
  void reconnect_timer()
  {
    ...
    try {
      ...
      unsigned short baud = get_parameter("baud").as_int();
  ...
  */
  bool configure_sensor(){
    ...
    RCLCPP_INFO(get_logger(), "DataType : %d", AsyncDataOutputType);
    ...
    vn::sensors::SynchronizationControlRegister configSync = {
      ...
      (unsigned short)get_parameter("syncInSkipFactor").as_int(),
      ...
      (unsigned short)get_parameter("syncOutSkipFactor").as_int(),
      (unsigned short)get_parameter("syncOutPulseWidth_ns").as_int()
    };
    ...
    for(auto name : boRegs){
      vn::sensors::BinaryOutputRegister configBO = {
        ...
        (unsigned short)get_parameter(name + ".rateDivisor").as_int(),
